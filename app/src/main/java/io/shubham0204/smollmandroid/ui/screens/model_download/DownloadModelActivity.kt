...
class DownloadModelActivity : ComponentActivity() {
    ...
    private fun getRecommendedModelUrl(): String {
        ...
        return when {
            ...
            availRamGb >= 7.0  -> "https://huggingface.co/bartowski/Qwen_Qwen3-4B-GGUF/resolve/main/Qwen_Qwen3-4B-Q8_0.gguf"
          ...
          availRamGb >= 2.0  -> "https://huggingface.co/bartowski/Qwen_Qwen3-1.7B-GGUF/resolve/main/Qwen_Qwen3-1.7B-Q4_K_M.gguf"
